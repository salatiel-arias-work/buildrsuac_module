...
int MCP2515Class::begin(long baudRate)
{
  ...
  // Bit time of 10 Tqs is used as a default value for all CAN baudrates 
  // SyncSeg (1Tq) | PropSeg (1Tq) | PS1 (4Tq) | PS2 (4Tq)
  const struct {
    long clockFrequency;
    long baudRate;
    uint8_t cnf[3];
  } CNF_MAPPER[] = {
    { (long)20E6, (long)1000E3, { 0x00, 0x98, 0x03 } }, 
    { (long)20E6,  (long)500E3, { 0x01, 0x98, 0x03 } }, 
    { (long)20E6,  (long)250E3, { 0x03, 0x98, 0x03 } }, 
    { (long)20E6,  (long)125E3, { 0x07, 0x98, 0x03 } }
  };
